...
public static class PermissionCodes
{
    ...
    [
        ...
        (LocationsView, "Locations", "View", "View warehouse locations"),
        (LocationsManage, "Locations", "Manage", "Manage warehouse locations"),
        ...
        (CompanyView, "Company", "View", "View company profile"),
        (CompanyEdit, "Company", "Edit", "Edit company profile"),
        (WarehouseView, "Warehouse", "View", "View warehouses"),
        (WarehouseCreate, "Warehouse", "Create", "Create warehouses"),
        (WarehouseEdit, "Warehouse", "Edit", "Edit warehouses"),
        (WarehouseDelete, "Warehouse", "Delete", "Delete warehouses"),
