...
export const DEMO_OUTBOUND: OutboundOrder[] = [
  {
    ...
    destination: "1200 Industrial Parkway, TX 77001, United States",
    attachment: {
      name: "packing-list-OUT-2201.pdf",
      size: 84211,
  ...
  },
  {
    ...
    trackingNumber: "ODFL-99441207",
    address: "880 Distribution Blvd",
    state: "NC",
    postalCode: "28202",
    country: "United States",
    destination: "880 Distribution Blvd, NC 28202, United States",
    status: "Shipped",
    shippedAt: "2026-08-03T18:22:00Z",
    attachment: {
      name: "bol-OUT-2194.pdf",
      size: 61204,
      type: "application/pdf",
    },
    lineCount: 5,
  ...
  },
  {
    ...
    address: "45 Harbor Way",
    state: "GA",
    postalCode: "30301",
    country: "United States",
    destination: "45 Harbor Way, GA 30301, United States",
    status: "Picking",
    lineCount: 2,
    totalWeight: 640,
    totalPallets: 1,
  ...
  {
    id: "out-4",
    orderNumber: "OUT-2026-2208",
    warehouseId: "wh-1",
    warehouseName: "LogiForge Demo 3PL",
    customerId: "cust-1",
    customerName: "Acme Industrial",
    shipDate: "2026-08-04T14:15:00Z",
    carrier: "FedEx Freight",
    ...
    destination: "1200 Industrial Parkway, TX 77001, United States",
    status: "Shipped",
    shippedAt: "2026-08-04T14:08:00Z",
    attachment: {
      name: "packing-list-OUT-2208.pdf",
      size: 90412,
      type: "application/pdf",
    },
    lineCount: 2,
  ...
  {
    id: "out-5",
    orderNumber: "OUT-2026-2210",
    warehouseId: "wh-1",
    warehouseName: "LogiForge Demo 3PL",
    customerId: "cust-2",
    customerName: "Nordic Polymers",
    shipDate: "2026-08-04T16:40:00Z",
    carrier: "XPO Logistics",
    trackingNumber: "XPO-55190244",
    address: "880 Distribution Blvd",
    state: "NC",
    postalCode: "28202",
    country: "United States",
    destination: "880 Distribution Blvd, NC 28202, United States",
    status: "Shipped",
    shippedAt: "2026-08-04T16:35:00Z",
    attachment: {
      name: "packing-list-OUT-2210.pdf",
      size: 55120,
      type: "application/pdf",
    },
    lineCount: 1,
  ...
  {
    id: "out-6",
    orderNumber: "OUT-2026-2212",
    warehouseId: "wh-2",
    warehouseName: "Harborline Logistics",
    customerId: "cust-1",
    customerName: "Acme Industrial",
    shipDate: "2026-08-04T11:20:00Z",
    carrier: "SAIA",
    trackingNumber: "SAIA-8834102",
    address: "1200 Industrial Parkway",
    state: "TX",
    postalCode: "77001",
    country: "United States",
    destination: "1200 Industrial Parkway, TX 77001, United States",
    status: "Shipped",
    shippedAt: "2026-08-04T11:12:00Z",
    attachment: {
      name: "bol-OUT-2212.pdf",
      size: 48330,
      type: "application/pdf",
    },
    lineCount: 1,
...
export const DEMO_REPORTS: ReportDefinition[] = [
  {
    ...
    category: "Outbound",
    description:
      "Outbound shipments by day — every order confirmed shipped on the selected day.",
  },
  {
    id: "rpt-1",
